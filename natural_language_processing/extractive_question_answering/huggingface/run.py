...
def run_pytorch(model_name, batch_size, num_runs, timeout, squad_path, **kwargs):
    ...
    def tokenize(question, text):
        return tokenizer(question, text, add_special_tokens=False, max_length=384, stride=128,
                         return_overflowing_tokens=True, return_offsets_mapping=True, truncation="only_first",
                         padding="max_length")
